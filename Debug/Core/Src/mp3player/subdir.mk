...
C_SRCS += \
../Core/Src/mp3player/mp3player.c 

C_DEPS += \
./Core/Src/mp3player/mp3player.d 

OBJS += \
./Core/Src/mp3player/mp3player.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/mp3player/%.o: ../Core/Src/mp3player/%.c Core/Src/mp3player/subdir.mk
